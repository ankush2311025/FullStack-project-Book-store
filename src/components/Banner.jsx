...
export default function Banner() {
  return (
    ...
    <div className='max-w-screen-2x1 container mx-auto md:px-20 px-4 flex flex-col md:flex-row my-10'>
        ...
        <p className='text-xl'>
            Just a simple blog where you can Learn something new everyday
        </p>
...
<button className="btn ml-3 btn-secondary">Secondary</button>
        </div>
        </div>
        <div className='order-1 w-full md:w-1/2'>
        <img src ={banner} className='mt-50 rounded-full'  alt=''/></div>
    </div>
    </>
